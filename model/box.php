...
class Box
{
    ...
    {
        if (!$this->title)
            $query = "UPDATE `box` SET `description_text`='$this->description_text' where id=$this->id";
        else if (!$this->description_text)
            $query = "UPDATE `box` SET `title` = '$this->title'  where id=$this->id";
        else
            $query = "UPDATE `box` SET `title` = '$this->title' , `description_text`='$this->description_text' where id=$this->id";
