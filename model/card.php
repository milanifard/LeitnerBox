...
class Card
{
    ...
    function editById()
    {
        ...
        $query = "UPDATE $this->table_name SET
                ...
                back_image_name = :back_image_name,
                created_at = :created_at,
                back_audio_name = :back_audio_name where id=$this->id";
    ...
    function deleteByID()
    {
        ...
        if ($this->front_image_name) {
            unlink("../../LeitnerBox/user_files/images/$this->front_image_name");
            
        }
        if ($this->front_audio_name) {
            unlink("../../LeitnerBox/user_files/audios/$this->front_audio_name");
        }
        if ($this->back_image_name) {
            unlink("../../LeitnerBox/user_files/images/$this->back_image_name");
        }
        if ($this->back_audio_name) {
            unlink("../../LeitnerBox/user_files/audios/$this->back_audio_name");
        }
        $query = "DELETE FROM 
                    " . $this->table_name . "
                WHERE
